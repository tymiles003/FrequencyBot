...
${OBJECTDIR}/Coinbase.o: Coinbase.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Coinbase.o Coinbase.cpp

${OBJECTDIR}/FrequencyBot.o: FrequencyBot.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FrequencyBot.o FrequencyBot.cpp

${OBJECTDIR}/Kraken.o: Kraken.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Kraken.o Kraken.cpp

${OBJECTDIR}/Robinhood.o: Robinhood.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Robinhood.o Robinhood.cpp
